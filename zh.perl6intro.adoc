...
.Windows
. 从 http://rakudo.org/downloads/star/ 下载最新的安装程序(.msi 后缀的文件) +
...
这是一个新式的文本编辑器，自带现成的 Perl 6 语法高亮功能。
...
最新版的 Vim 自带 Perl 6 语法高亮功能，Emacs 和 Padre 则需要另行安装额外的包。


=== Hello World!
按照老规矩，我们会从 `hello world` 程序开始。
...
=== 语法概要
Perl 6 是 *形式自由的*: 你可以使用(大多数时候)任意数量的空格。
